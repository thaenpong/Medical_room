...
include 'connect.php';
//login
if (isset($_SESSION['medical_login']) == "logined") {
...
if (isset($_POST['submit'])) {
    ...
    if ($num >= 1) {
        ...
        $_SESSION['medical_login'] = "logined"; // ทำการสร้าง Session "admin" เพื่อใช้ในการตรวจสอบการเข้าระบบ
                    ...
                    <div class="card-body">
                        <form action="" method="post" autocomplete="off">
                            ...
                            <div class="form-group my-2">
                                <input type="text" class="form-control" name="username" placeholder="ชื่อผู้ใช้" required value="admin">
                            </div>
                            <div class="form-group my-2">
                                <input type="password" class="form-control" name="password" placeholder="รหัสผ่าน" required value="admin">
                            </div>
